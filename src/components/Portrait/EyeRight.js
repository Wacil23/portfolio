...
const EyeRight = () => {
    ...
    return (
        <div className='right-eye relative w-fit overflow-hidden bottom-[221px] left-[53%]  md:bottom-[298px] z-20 md:left-[55%]'>
            ...
            <div id='right-eye' style={{ transform: rotateRightEye }} className='bg-transparent top-[22%] left-[17%] md:top-[4%] md:left-[25%] absolute flex items-center justify-end rounded-full w-4 h-4 md:w-8 md:h-8'>
